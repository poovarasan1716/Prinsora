      ...
      <div className="pt-24 pb-20">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            >
              <h2
                className="font-serif text-2xl font-medium mb-6"
                ...
                {mockOrders.map((order) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-xs" style={{ color: 'hsl(38 30% 50%)' }}>
                        {order.date}
                      </span>
                      <span className="text-sm font-semibold" style={{ color: 'hsl(45 75% 58%)' }}>
                  ...
                  {wishlistProducts.map((product) => (
                    <Link href={`/product/${product.id}`} key={product.id}>
                      ...
                      >
                        ...
                        <div>
                          <h3 className="font-serif font-medium mb-1" style={{ color: '#f5f0e8' }}>
                            {product.name}
                          </h3>
                          <p className="text-sm" style={{ color: 'hsl(45 75% 58%)' }}>
